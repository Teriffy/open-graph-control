...
final class TitleTest extends TestCase {
	 ...
	 */
	private function resolver( array $postmeta = [], ?array $chain = null ): Title {
		...
		$opt_repo->method( 'get_path' )->willReturn( $chain ?? [ 'post_meta_override', 'seo_plugin_title', 'post_title', 'site_name' ] );

		return new Title( $post_repo, $opt_repo );
	}
