...
final class DefaultSettings {
	...
	private static function fallback_chains(): array {
		return [
			...
			'description' => [ 'post_meta_override', 'seo_plugin_desc', 'post_excerpt', 'post_content_trim', 'site_description' ],
			'image'       => [ 'post_meta_override', 'featured_image', 'first_content_image', 'first_block_image', 'site_master_image' ],
		];
	}
}
